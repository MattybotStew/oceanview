...
const buttonStyles = {
  baseHero: {
    ...
    fontFamily: "var(--ov-ff-sans)", fontWeight: 700, fontSize: 14.8,
    cursor: "pointer", letterSpacing: ".005em", transition: "opacity .15s ease",
  },
  baseSm: {
    border: 0, padding: "12px 28px", borderRadius: 200,
    fontFamily: "var(--ov-ff-sans)", fontWeight: 700, fontSize: 14,
  ...
  textLink: {
    fontFamily: "var(--ov-ff-body)", fontWeight: 500, fontSize: 15,
