    ...
    tabs: [
      {
        ...
        heading: "Fixed Annuities",
        body: "Guaranteed interest rate for a defined period — predictable, tax-deferred growth with no market exposure.",
        links: [
          { label: "Harbourview MYGA",      href: "#harbourview-myga",     desc: "Guaranteed premium, guaranteed yield, and the benefits of tax deferral over a defined term." },
          { label: "Horizon MYGA",          href: "#horizon-myga",         desc: "A clear path to predictable growth — straightforward guaranteed accumulation with no market exposure." },
          { label: "Sky Harbourview MYGA",  href: "#sky-harbourview-myga", desc: "Guaranteed yield, tax-deferred growth, and a death benefit for beneficiaries included at no extra cost." },
        ],
      },
      {
        label: "Fixed Annuities with Flexibility",
        eyebrow: "FLEXIBLE GROWTH",
        heading: "Fixed Annuities with Flexibility",
        body: "Guaranteed interest today with options to adjust as your retirement goals evolve.",
        links: [
          { label: "Current Rate Fixed Annuity", href: "#current-rate-fia", desc: "Start with a guaranteed rate, then choose your path at renewal — structured growth with built-in flexibility." },
          { label: "Harbourview FIA",            href: "#harbourview-fia",  desc: "Balanced growth potential linked to market indexes with 100% principal protection and multiple crediting strategies." },
        ],
      },
      {
