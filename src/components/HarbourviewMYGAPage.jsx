...
const PRODUCT = {
  ...
  tagline: "A guaranteed premium, a guaranteed yield, and the advantages of tax deferral — designed for individuals seeking predictable, protected growth over a defined term.",
  ...
  contractProvides: {
    eyebrow: "Why Harbourview MYGA",
    heading: "What your contract provides",
    sub: "Five core protections and benefits built into every Harbourview MYGA contract.",
    items: [
    ...
    download: { title: "Harbourview MYGA Product Overview", sub: "Summary brochure with all contract details" },
  },
  ...
  keyTerms: {
    ...
    sub: "Core parameters of the Harbourview Multi-Year Guaranteed Annuity contract.",
    items: [
  ...
  surrenderSchedule: {
    ...
    rows: [
      { year: 1,  charges: ["5%",   "7%",   "9%",   "10%"] },
      { year: 2,  charges: ["5%",   "7%",   "9%",   "10%"] },
      { year: 3,  charges: ["0%",   "7%",   "9%",   "10%"] },
      { year: 4,  charges: [null,   "3%",   "9%",   "10%"] },
      { year: 5,  charges: [null,   "0%",   "7%",   "10%"] },
  ...
  surrenderOptions: {
    ...
    footnote: "*For most states, Harbourview MYGA Policy Form: ICC19OLASMA. Product features, options, form numbers, and availability may vary by state. This is a brief description meant for informational purposes only. Not individualized investment or financial advice.",
  },

  incomeOptions: {
    eyebrow: "Settlement Options",
    heading: "Income payment options",
    sub: "The Harbourview MYGA can provide an income stream for a term of your choosing, including for the rest of your life.",
    items: [
  ...
  cta: {
    heading: "Ready to explore the Harbourview MYGA?",
