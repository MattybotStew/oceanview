...
const PRODUCT = {
  ...
  name: "Topsider Fixed Indexed Annuity",
  ...
  stats: [
    ...
    { value: "3",             label: "Index Strategies",    sectionId: 'crediting-strategies' },
    { value: "10%",           label: "Free Withdrawal/Yr",  sectionId: 'key-terms'            },
    { value: "5–10",          label: "Term Options (Yrs)",  sectionId: 'key-terms'            },
    { value: "A (Excellent)", label: "A.M. Best Rating"                                       },
  ],

  contractProvides: {
    eyebrow: "Why Topsider FIA",
    heading: "What your contract provides",
    sub: "Six core protections and benefits built into every Topsider FIA contract.",
    items: [
      { title: "Upside Growth Potential",  body: "Pursue interest credits based on the performance of major market indexes — positioned for accumulation-focused clients." },
      { title: "Premium Protection",       body: "Your contract premium is 100% principal protected. Negative index performance results in zero interest credit — your floor is zero." },
      { title: "Multiple Index Strategies", body: "Select from crediting strategies across three major indexes, each with defined limits that provide structured growth parameters." },
    ...
    download: { title: "Topsider FIA Product Overview", sub: "Summary brochure with all contract details" },
  },

  creditingStrategies: {
    eyebrow: "Crediting Strategies",
    heading: "Choose your growth approach",
    sub: "Select from index crediting strategies across three major indexes, each designed to pursue upside interest credits within a clearly defined structure.",
    tabs: [
      {
        label: "S&P 500",
        strategies: [
  ...
  keyTerms: {
    ...
    sub: "Core parameters of the Topsider Fixed Indexed Annuity contract.",
    items: [
      ...
      { label: "Term Options",             value: "5, 7, and 10 years" },
      { label: "Free Withdrawals",         value: "10% of Contract Value on or after first contract anniversary. Minimum withdrawal amount: $250" },
      ...
      { label: "Market Value Adjustment",  value: "A positive or negative adjustment based on the interest rate environment at time of withdrawal. Applies to withdrawals exceeding the 10% free withdrawal before end of the surrender charge period. Does not apply to death benefit, 10% free withdrawals, or annuitization." },
    ],
  ...
  surrenderSchedule: {
    ...
    terms: ["5-Year", "7-Year", "10-Year"],
    rows: [
      { year: 1,  charges: ["9%",  "9%",  "10%"] },
      { year: 2,  charges: ["8%",  "8%",  "9%"]  },
      { year: 3,  charges: ["7%",  "7%",  "8%"]  },
      { year: 4,  charges: ["6%",  "6%",  "7%"]  },
      { year: 5,  charges: ["5%",  "5%",  "6%"]  },
      { year: 6,  charges: [null,  "4%",  "5%"]  },
      { year: 7,  charges: [null,  "3%",  "4%"]  },
      { year: 8,  charges: [null,  null,  "3%"]  },
      { year: 9,  charges: [null,  null,  "2%"]  },
      { year: 10, charges: [null,  null,  "1%"]  },
    ],
  ...
  incomeOptions: {
    ...
    sub: "The Topsider FIA can provide an income stream for a term of your choosing, including for the rest of your life.",
    items: [
  ...
  cta: {
    heading: "Ready to explore the Topsider FIA?",
    sub: "Talk to a financial professional or contact our team to find the index crediting strategy that fits your retirement goals.",
    buttonLabel: "Get Started",
  },
}

export default function TopsiderFIAPage() {
